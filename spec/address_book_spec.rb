...
RSpec.describe AddressBook do
  # #1 create new instance of AddressBook model and assign it to book variable using let; adds book to all of our tests
  let(:book) { AddressBook.new }

 # #6 helper method to consolidate redundant code
  ...
  # #2 it explains functionality of the method
  ...
  describe "#remove_entry" do
    it "a single entry is removed" do
      book.add_entry('Julie Currier', '716.555.5555', 'julie.currier@lovelace.com')
      ...
      expect(book.entries.first.name).to eq('Julie Currier')
    end
  end
  ...
  describe "#import_from_csv" do
    it "imports the correct number of entries" do
      # #3 pass string entries.csv as a parameter
      book.import_from_csv("entries.csv")
      book_size = book.entries.size #get the size; an array
    ...
    it "imports the 1st entry" do
      ...
      # #5 added 3 expects to verify the entry information
   ...
   describe "#imports from entries2.csv" do
